  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.title}>Your All-in-One Plant Care Companion</Text>
        <Text style={styles.description}>
          CofCap helps you care for your plants. Set reminders, document their growth, and diagnose
          diseases with a quick camera scan.
        </Text>
      ...
      <View style={styles.footer}>
        ...
        <Pressable
          ...
          onPress={() => router.replace('/walkthrough-3')}>
