 ...
 * List of frequently encountered plant diseases with descriptions
 */
export const COMMON_DISEASES: DiseaseItem[] = [
  ...
  },
  {
    ...
    name: "Agaricomycetes",
    image:
      "https://images.unsplash.com/photo-1551065980-fc0403300878?w=400&q=80",
    description:
  ...
  },
  {
    ...
    name: "Alternaria",
    image:
      "https://images.unsplash.com/photo-1558905628-66a98fb49ea6?w=400&q=80",
    description:
  ...
  },
  {
    ...
    name: "Bacteria",
    image:
      "https://images.unsplash.com/photo-1528629202416-2da983637651?w=400&q=80",
    description:
  ...
  },
  {
    ...
    name: "Garden Pests",
    image:
      "https://images.unsplash.com/photo-1599591410423-f308ce7a8f81?w=400&q=80",
    description:
...
/**
 * Disease Categories
 * Organizes diseases by affected plant part
 */
export const DISEASE_CATEGORIES: DiseaseCategory[] = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1487010363384-6b814d73ae4e?w=400&q=80",
  },
  {
    id: "fruits",
    title: "Diseases in Fruits",
    image:
      "https://images.unsplash.com/photo-1423483641154-5411ec9c0ddf?w=400&q=80",
  },
];

/**
 * Detailed Disease Information
 * Comprehensive data including symptoms, causes, treatments, and prevention
 * Used in disease detail screens
 */
