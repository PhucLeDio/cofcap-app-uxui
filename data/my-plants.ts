export type PlantAction = 'Watering' | 'Fertilizing' | 'Photo' | 'Misting' | 'Note' | 'Rotating';
...
export const MY_PLANTS: UserPlant[] = [
  {
    ...
    genus: 'Calathea',
    image: 'https://images.unsplash.com/photo-1613735164870-13b3554e0193?w=800&q=80',
  ...
  },
  {
    ...
    genus: 'Dracaena',
    image: 'https://images.unsplash.com/photo-1593019808399-52e85eb6eac2?w=800&q=80',
  ...
  },
  {
    ...
    genus: 'Graptopetalum',
    image: 'https://images.unsplash.com/photo-1555582963-4414eb1f07f4?w=800&q=80',
    needs: ['water', 'sun'],
  },
  {
    id: 'aloe-vera',
    ...
    genus: 'Aloe',
    image: 'https://images.unsplash.com/photo-1596547609652-9fc5d8d428ce?w=800&q=80',
    needs: ['water', 'nutrition', 'mist', 'sun'],
  },
  {
    id: 'jade-plant',
    ...
    genus: 'Crassula',
    image: 'https://images.unsplash.com/photo-1599814421160-c3d31fc3c25b?w=800&q=80',
    needs: ['water', 'sun'],
  }
];
